...
import { IClass, IClassSubject, IPaginatedResponse, ISubject } from '@/interfaces'
...
import { apiGetClass, apiGetClasses, apiGetClassSubjects } from '@/services/ClassService'


const ClassSubjects = ({ params }: { params: { id: string } }) => {
